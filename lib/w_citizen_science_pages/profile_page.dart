...
import 'package:bmd_weather_app/w_citizen_science_controller/profile/ProfileController.dart';
...
class CitizenScienceProfilePage extends StatefulWidget {
  @override
  State<CitizenScienceProfilePage> createState() => _CitizenScienceProfilePageState();
}

class _CitizenScienceProfilePageState extends State<CitizenScienceProfilePage> {
  final controller = Get.put(CitizenScienceProfileController());
  final isBangla = Get.locale?.languageCode == 'bn';
  final CitizenScienceDashboardController d_controller =
      Get.find<CitizenScienceDashboardController>();
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      // First Name
                      sectionLabel("full_name_label".tr),
                      profileTextField(controller.fullNameController),

                      SizedBox(height: 16.h),

                      sectionLabel("email_label".tr),
                      profileTextField(controller.emailController),

...
class WaterWatchMobile extends StatefulWidget {
  const WaterWatchMobile({super.key});

  @override
  State<WaterWatchMobile> createState() => _WaterWatchMobileState();
}

class _WaterWatchMobileState extends State<WaterWatchMobile> {

  WaterWatchMobileController controller = Get.put(WaterWatchMobileController());

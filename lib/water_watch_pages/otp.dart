...
import '../water_watch_controller/otp/OtpController.dart';

class WaterWatchOtp extends StatefulWidget {
  const WaterWatchOtp({super.key});

  @override
  State<WaterWatchOtp> createState() => _WaterWatchOtpState();
}

class _WaterWatchOtpState extends State<WaterWatchOtp> {

  WaterWatchOtpController controller = Get.put(WaterWatchOtpController());
